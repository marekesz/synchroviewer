...
public class DimensionsForSubsetToolbar extends DockToolbar
{
    ...
    public DimensionsForSubsetToolbar(String name, boolean visibleOnStart, Automaton automaton)
    {
    ...
    private void recalculate()
    {
        ...
        lengthLabel.setText(String.format("%n Dimensions: %d", dimensions.size()));
    }
