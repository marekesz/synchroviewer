...
public abstract class AutomatonHelper {
    ...
    public static final char[] TRANSITIONS_LETTERS = { 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j' };

    public static final Color[] TRANSITIONS_COLORS = { Color.RED, Color.GREEN, Color.BLUE, Color.ORANGE, Color.PINK,
