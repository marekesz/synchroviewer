...
public abstract class Synchronizability {
  ...
  public static boolean isIrreduciblySynchronizing(DFA automaton, InverseDFA inverseAutomaton) {
  ...
  public static boolean isSynchronizing(DFA automaton, InverseDFA inverseAutomaton) {
    return isSynchronizing(automaton, inverseAutomaton, -1);
  }

  private static boolean isSynchronizing(DFA automaton, InverseDFA inverseAutomaton, int ommitLetter) {
